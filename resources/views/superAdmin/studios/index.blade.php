...
<div class="row g-3 justify-content-center">
   <div class="card card-one mt-3">
      <div class="card-header">
         <h6 class="card-title">Gallery List</h6>
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="{{ route('studios.create')}}" class="btn btn-primary btn-icons"><i class="ri-add-fill"></i> Add
            Gallery</a>
         </nav>
      </div>
        ...
        <div class="table-responsive">
            <table  id="datatable-buttons" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0;">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('studios.show',$studio->id) }}" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                           <a href="{{ route('studios.edit',$studio->id) }}" class="dropdown-item rename"><i class="ri-edit-2-line"></i>
                           Edit</a>
                           
                              <a href="#modal-{{$studio->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i
                  ...
                  <div class="modal fade" id="modal-{{$studio->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong>{{$studio->name }}</strong> </div>
                            </div>
