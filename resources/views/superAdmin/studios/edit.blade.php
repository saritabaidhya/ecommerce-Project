        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <ol class="breadcrumb fs-sm mb-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{$studio->title}}</li>
                </ol>
                        ...
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{$studio->name}}" class="form-control"  placeholder="Enter studio name">
                                  </div>  
...
@endif
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($studio->path)
                                    <img src="{{ asset('storage/images/' . $studio->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>
                            </div>   
                        </div>
