   ...
   <div class="card card-one mt-3">
      <div class="card-header">
         ...
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="{{ route('squads.create')}}" class="btn btn-primary btn-icons"><i class="ri-add-fill"></i> Add
               Team</a>
         </nav>
      </div>
            ...
            <table  id="datatable-buttons" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0;">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>{{$squad->name}}</td>
                     <td><span class="">{{$squad->status}}</span></td>
                     <td>{{$squad->created_at}}</td>
                     <td>{{$squad->updated_at}}</td>
                     <td>
                        <a href="" class="dropdown-link" data-bs-toggle="dropdown"
                           aria-expanded="false"><i class="ri-more-2-fill"></i></a>
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('squads.show',$squad->id) }}" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                           <a href="{{ route('squads.edit',$squad->id) }}" class="dropdown-item rename"><i class="ri-edit-2-line"></i>
                           Edit</a>
                           
                              <a href="#modal-{{$squad->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i
                  ...
                  <div class="modal fade" id="modal-{{$squad->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong> {{$squad->name }} </strong></div>
                            </div>
