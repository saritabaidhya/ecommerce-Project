...
<div class="d-flex align-items-center justify-content-between mb-4">
   <div>
      ...
      <h4 class="main-title name mb-0">User Profile</h4>
   </div>
...
<div class="card card-one mt-3">
   <div class="card-header">
      ...
      <nav class="nav nav-icon nav-icon-sm ms-auto">
         <a href="{{ route('profile.index')}}" class="btn btn-primary btn-icons"><i class="ri-arrow-left-line me-2"></i> Back</a>
      </nav>
   </div>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="mb-3">
                ...
                <textarea id="basic-conf" class="form-control" name="detail" rows="3" placeholder="Write here...">{{ $profile->detail }}</textarea>
            </div>
