        ...
        <div class="row g-3 justify-content-center">
            <div class="card card-one mt-3">
                ...
                <div class="card-body p-3">
                    <form action="{{ route('approaches.update',$approach->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{$approach->name}}" class="form-control"  placeholder="Enter approach name">
                                  </div>  
                                  <div class="mb-3">
                                    <label  class="form-label">detail</label>
                                    <input type="text" name="detail" value="{{ $approach->detail }}" class="form-control"  placeholder="Enter approach name">
                                 </div>
                                 <div class="row">
                                    <div class="col-md-12">
               ...
               <fieldset>
                ...
                <!--end repeater-->
                                  ...
                                  {{-- <div class="mb-3">
                                    ...
                                    <textarea id="basic-conf" class="form-control" name="detail" rows="3" placeholder="Write here..."> {{$approach->detail}}</textarea>
                                  </div> --}}
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="status" aria-label="Default select example">
                                    <option value="1" {{ $approach->status  == '1' ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ $approach->status  == '0' ? 'selected' : '' }}>Inactive</option>
                                  </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="category" aria-label="Default select example">
                                       <option value="horoscope" {{ $approach->category  == 'horoscope' ? 'selected' : '' }}>horoscope</option>
                                       <option value="app" {{ $approach->category  == 'app' ? 'selected' : '' }}>app</option>
                                       <option value="marketplace" {{ $approach->category  == 'marketplace' ? 'selected' : '' }}>marketplace</option>
                                    </select>
                                 </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($approach->path)
                                    <img src="{{ asset('storage/images/' . $approach->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <input type="text" name="facebook"  class="form-control" value="{{$approach->facebook}}"  placeholder="Enter facebook profile link">
                                 </div>
                            </div>   
                        </div>
