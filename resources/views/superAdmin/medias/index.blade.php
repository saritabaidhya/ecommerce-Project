   ...
   <div class="card card-one mt-3">
      <div class="card-header">
         ...
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="{{ route('medias.create')}}" class="btn btn-primary btn-icons"><i class="ri-add-fill"></i> Add
            Media </a>
         </nav>
      </div>
            ...
            <div class="row g-2 g-lg-3">
              ...
              <div class="col-md-3">
                <div class="music-item">
                  <img src="{{ asset('storage/images/' . $media->path) }}" alt="" class="img-fluid">
                  <h6 class="music-title"><a href="#">{{$media->title}}</a></h6>
                  <p class="music-text"><a href="#modal-{{$media->id }}" data-bs-toggle="modal" class="delete"><i
              ...
              <div class="modal fade" id="modal-{{$media->id }}" tabindex="-1" aria-hidden="true">
                 ...
                 <div class="modal-content">
                   ...
                   <div class="modal-body">
                       <div class="row"> 
                           ...
                           <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong>{{$media->title }}</strong> </div>
                       </div>
