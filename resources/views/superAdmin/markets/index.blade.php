   ...
   <div class="card card-one mt-3">
      <div class="card-header">
         ...
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="{{ route('markets.create')}}" class="btn btn-primary btn-icons"><i class="ri-add-fill"></i> Add
            Service</a>
         </nav>
      </div>
    ...
    <div class="form-check form-switch">
        <input class="form-check-input" disabled type="checkbox" name="status"  value="{{$market->status}}" role="switch"  id="flexSwitchCheck{{$market->id}}" 
               @if($market->status) checked @endif >
    </div>
</td>
                     ...
                     <td>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('markets.show',$market->id) }}" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                           <a href="{{ route('markets.edit',$market->id) }}" class="dropdown-item rename"><i class="ri-edit-2-line"></i>
                           Edit</a>
                           
                              <a href="#modal-{{$market->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i
                  ...
                  <div class="modal fade" id="modal-{{$market->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong> {{$market->name }}</strong> </div>
                            </div>
