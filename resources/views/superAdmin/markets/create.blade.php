  ...
  <div class="d-flex align-items-center justify-content-between mb-4">
    <div>
      <ol class="breadcrumb fs-sm mb-1">
        ...
        <li class="breadcrumb-item active" aria-current="page">Market Place Products</li>
      </ol>
      <h4 class="main-title mb-0">Market Place Products</h4>
    </div>
  ...
  <div class="row g-3 justify-content-center">
    <div class="card card-one mt-3">
      <div class="card-header">
        <h6 class="card-title">Create Market Place Product List</h6>
      ...
      <div class="card-body p-3">
        <form action="{{ route('markets.store') }}" method="POST" enctype="multipart/form-data"> @csrf <div class="row">
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <select class="form-select" name="category" aria-label="Default select example">
                      <option value="Rudrakshya" selected>Rudrakshya</option>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="number" name="offprice" class="form-control"  placeholder="Enter ">
                  </div>
                </div>                
              </div>
                          ...
                          <div data-repeater-list="unitprice">
                              ...
                              <div data-repeater-item="">
                                  ...
                                  <div class="form-group row d-flex align-items-end ">
                                      ...
                                      <div class="col-sm-5 mb-2">
                                          <input type="number" name="unitprice[{{ $index }}][price]" class="form-control" placeholder="price" value="{{ $unitprice['price'] ?? '' }}">
                                      </div>
                                      <div class="col-sm-2 mb-2 ">
                                          <span data-repeater-delete="" class="btn btn-outline-danger form-control">
                                                  <span class="ri-delete-bin-line"></span>
