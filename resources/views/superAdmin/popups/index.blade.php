...
<div class="d-flex align-items-center justify-content-between mb-4">
   <div>
      ...
      <h4 class="main-title mb-0">Popups</h4>
   </div>
...
<div class="row g-3 justify-content-center">
   <div class="card card-one mt-3">
      <div class="card-header">
         <h6 class="card-title">Popup List</h6>
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="{{ route('popups.create')}}" class="btn btn-primary btn-icons"><i class="ri-add-fill"></i> Add
            Popup</a>
         </nav>
      </div>
            ...
            <table  id="datatable-buttons" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0;">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>{{$popup->name}}</td>
                     <td><span class="">{{$popup->status}}</span></td>
                     ...
                     <td>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('popups.show',$popup->id) }}" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                           <a href="{{ route('popups.edit',$popup->id) }}" class="dropdown-item rename"><i class="ri-edit-2-line"></i>
                           Edit</a>
                           
                              <a href="#modal-{{$popup->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i
                  ...
                  <div class="modal fade" id="modal-{{$popup->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong> {{$popup->name }} </strong> </div>
                            </div>
