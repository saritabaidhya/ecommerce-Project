            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="mb-3">
                     ...
                     <input type="text" name="name" class="form-control"  placeholder="Enter popup name">
                  </div>
                  <div class="mb-3">
                     <label  class="form-label">Descriptions / Redirection Link</label>
                     <textarea id="basic-confd" class="form-control" name="detail" rows="3" placeholder="Write here..."></textarea>
                  </div>
                  <div class="mt-3">
