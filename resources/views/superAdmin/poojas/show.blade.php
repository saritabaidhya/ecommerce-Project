        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <ol class="breadcrumb fs-sm mb-1">
                    ...
                    <li class="breadcrumb-item"><a href="/utilities">Services</a></li>
                ...
                <div class="card-body p-3">
                    <div class="video-headline">
                      ...
                      <div class="mt-3">
                        ...
                        <p class="d-flex gap-3 fs-sm text-secondary"><span>{{$utility->created_at}}</span><span>3 months ago</span></p>
                        {!! $utility->detail !!}
                      </div>
                </div><!-- card-body -->
            </div><!-- card -->
