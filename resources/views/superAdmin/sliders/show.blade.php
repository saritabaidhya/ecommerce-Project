        ...
        <div class="row g-3 justify-content-center">
            <div class="card card-one mt-3">
                <div class="card-header">
                    <h6 class="card-title">View Slider List</h6>
                ...
                <div class="card-body p-3">
                    <div class="video-headline">
                        <img src="{{ asset('storage/images/' . $slider->path) }}" alt="...">
                       
                      </div>
                      <div class="mt-3">
                        <h5 class="card-title">{{$slider->name}}</h5>
                        <p class="d-flex gap-3 fs-sm text-secondary"><span>{{$slider->created_at}}</span><span>Admin</span></p>
                        {!! $slider->detail !!}
                      </div>
                </div><!-- card-body -->
            </div><!-- card -->
