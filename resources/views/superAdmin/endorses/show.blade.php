        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <ol class="breadcrumb fs-sm mb-1">
                    ...
                    <li class="breadcrumb-item"><a href="/utilities">Partner</a></li>
        ...
        <div class="row g-3 justify-content-center">
            <div class="card card-one mt-3">
                <div class="card-header">
                    <h6 class="card-title">View partner</h6>
                ...
                <div class="card-body p-3">
                    <div class="video-headline">
                        <img src="{{ asset('storage/images/' . $associate->path) }}" alt="...">
                       
                      </div>
                      <div class="mt-3">
                        <h5 class="card-title">{{$associate->name}}</h5>
                        <p class="d-flex gap-3 fs-sm text-secondary"><span>{{$associate->created_at}}</span><span>3 months ago</span></p>
                        {!! $associate->detail !!}
                      </div>
                </div><!-- card-body -->
            </div><!-- card -->
