...
<div class="d-flex align-items-center justify-content-between mb-4">
   <div>
      ...
      <h4 class="main-title mb-0">Subscribes</h4>
   </div>
...
<div class="row g-3 justify-content-center">
   <div class="card card-one mt-3">
      <div class="card-header">
         <h6 class="card-title">Subscribe List</h6>
               ...
               <tbody>
                  @foreach ($endorses as $endorse)
                     <tr>
                        ...
                        <td>{{ $endorse->email }}</td>
                        <td>{{ $endorse->created_at }}</td>
                        <td>{{ $endorse->updated_at }}</td>
                        <td>
                           ...
                           <div class="dropdown-menu dropdown-menu-end" style="">                            
                                 ...
                                 <a href="#modal-{{$endorse->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i
                                    class="ri-delete-bin-line"></i>
                                 Delete</a>     
                           </div>
                        </td>

                        <div class="modal fade" id="modal-{{$endorse->id }}" tabindex="-1" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    <div class="row"> 
                                       ...
                                       <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong>{{$endorse->email }} </strong></div>
                                    </div>
                                    
                                 </div><!-- modal-body -->
                                 <div class="modal-footers text-end pb-2 pe-4">
                                    <form action="{{ route('endorses.destroy',$endorse->id) }}" method="POST">
                                       @csrf
                                       @method('DELETE')
