...
<div class="d-flex align-items-center justify-content-between mb-4">
   <div>
      ...
      <h4 class="main-title mb-0">Enquiry list</h4>
   </div>
...
<div class="row g-3 justify-content-center">
   <div class="card card-one mt-3">
      <div class="card-header">
         <h6 class="card-title">Enquiry list</h6>
               ...
               <tbody>
                   ...
                   <td>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('grievances.show',$grievance->id) }}" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                                                      
                              <a href="#modal-{{$grievance->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i
                    ...
                    <div class="modal fade" id="modal-{{$grievance->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong> {{$grievance->name}} </strong> </div>
                            </div>
                            
                        </div><!-- modal-body -->
                        <div class="modal-footers text-end pb-2 pe-4">
                            <form action="{{ route('grievances.destroy',$grievance->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
