        ...
        <div class="row g-3 justify-content-center">
            <div class="card card-one mt-3">
                <div class="card-header">
                    <h6 class="card-title">View Offer</h6>
                ...
                <div class="card-body p-3">
                    <div class="video-headline">
                        <img src="{{ asset('storage/images/' . $grant->path) }}" alt="...">
                       
                      </div>
                      <div class="mt-3">
                        <h5 class="card-title">{{$grant->name}}</h5>
                        <p class="d-flex gap-3 fs-sm text-secondary"><span>{{$grant->created_at}}</span><span>3 months ago</span></p>
                        {!! $grant->detail !!}
                      </div>
                </div><!-- card-body -->
            </div><!-- card -->
