...
<div class="d-flex align-items-center justify-content-between mb-4">
   <div>
      ...
      <h4 class="main-title mb-0">Contact Us</h4>
   </div>
               ...
               <tbody>
                   ...
                   <td>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('connects.show',$connect->id) }}" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                           <a href="{{ route('connects.edit',$connect->id) }}" class="dropdown-item rename"><i class="ri-edit-2-line"></i>
                           Edit</a>
                           
                              <a href="#modal-{{$connect->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i
                                 class="ri-delete-bin-line"></i>
                              Delete</a>     
                        </div>
                     </td>
                   </tr>
                   <div class="modal fade" id="modal-{{$connect->id }}" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                <div class="col-md-3"> <img src="{{ asset('superAdmin/img/93480.png') }}" class="img-fluid"> </div>

                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong>{{$connect->name }} </strong></div>
                            </div>
                            
                        </div><!-- modal-body -->
                        <div class="modal-footers text-end pb-2 pe-4">
                            <form action="{{ route('connects.destroy',$connect->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
