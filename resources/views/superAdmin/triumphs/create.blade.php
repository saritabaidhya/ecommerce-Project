...
<div class="row g-3 justify-content-center">
   <div class="card card-one mt-3">
      <div class="card-header">
         <h6 class="card-title">Create Success Gallery List</h6>
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="{{ route('triumphs.index')}}" class="btn btn-primary btn-icons"><i class="ri-arrow-left-line me-2"></i> Back</a>
         </nav>
      </div>
      <div class="card-body p-3">
         <form action="{{ route('triumphs.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
               <div class="col-md-8">
                  <div class="mb-3">
                  ...
                  <div class="row"> 
                     ...
                     <input type="text" name="designation" class="form-control"  placeholder="Enter student designation">
                  </div>   
                     </div>
                     <div class="col-md-6">
                     <div class="mb-3">
                     ...
                     <input type="text" name="institute" class="form-control"  placeholder="Enter College / Institute">
                  </div>   
                     </div>
                  </div>
                  <div class="mt-3">
