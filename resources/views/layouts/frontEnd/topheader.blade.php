                    ...
                    <div class="col-auto">
                        ...
                        <nav class="navbar navbar-expand u-header__navbar py-0 justify-content-xl-between max-width-270 min-width-270">
                            ...
                            <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center" href="/" aria-label="Electro">
                                <img src="{{ asset('storage/images/' . $settings->first()->path) }}" alt="image" class="logo__img">
                            </a>
                            <!-- End Logo -->
                                    ...
                                    <div class="u-header-sidebar__footer-offset">
                                        ...
                                        <div class="js-scrollbar u-sidebar__body">
                                            <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                                                <!-- Logo -->
                                                <a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-center mb-3" href="index-2.html" aria-label="Electro">
                                                    <img src="{{ asset('storage/images/' . $settings->first()->path) }}" alt="image" class="logo__img">
                                                ...
                                                <ul id="headerSidebarList" class="u-header-collapse__nav">                                                  
                                                    ...
                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                        ...
                                                        data-target="#headerSidebarAccessoriesCollapse{{ $utilitytype->id }}" role="button" 
                                                            data-toggle="collapse" aria-expanded="false" aria-controls="headerSidebarAccessoriesCollapse{{ $utilitytype->id }}">
                                                            {{ $utilitytype->name }}
                                                        </a>

                                                        <div id="headerSidebarAccessoriesCollapse{{ $utilitytype->id }}" class="collapse" data-parent="#headerSidebarContent">
                                                            <ul class="u-header-collapse__nav-list">
                                                                @foreach($utilitysubtypes->where('category', $utilitytype->id) as $subtype)
                                                                <li><a class="u-header-collapse__submenu-nav-link" href="#">{{ $subtype->name }}</a></li>
                                                                @endforeach
                                                            </ul>
                                                        </div>
                                                    </li>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <select class="js-select selectpicker dropdown-select custom-search-categories-select"
                                        ...
                                        @foreach($utilitytypes as $utilitytype)         
                                        <option value="{{ $utilitytype->name }}">{{ $utilitytype->name }}</option>
                                        @endforeach
                                    </select>
                                    <!-- End Select -->
                            ...
                            <ul class="d-flex list-unstyled mb-0 align-items-center">
                                ...
                                <li class="col pr-xl-0 px-2 px-sm-3 d-xl-none">
                                    <a href="#" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                        ...
                                        <span class="bg-lg-down-black width-22 height-22 bg-primary position-absolute d-flex align-items-center justify-content-center rounded-circle left-12 top-8 font-weight-bold font-size-12">{{ $cartCount }}</span>
                                        <span class="d-none d-xl-block font-weight-bold font-size-16 text-gray-90 ml-3">Rs.{{ number_format($cartTotal, 2) }}</span>
                                    </a>
                                </li>
                                ...
                                <li class="col pr-xl-0 px-2 px-sm-3 d-none d-xl-block">
                                    ...
                                    <div id="basicDropdownHover" class="cart-dropdown dropdown-menu dropdown-unfold border-top border-top-primary mt-3 border-width-2 border-left-0 border-right-0 border-bottom-0 left-auto right-0"
         aria-labelledby="basicDropdownHoverInvoker">

        @if(count($cart))
            <ul class="list-unstyled px-3 pt-3">
                @foreach(array_slice($cart, 0, 3) as $id => $item)
                <li class="border-bottom pb-3 mb-3">
                    <div class="">
                        <ul class="list-unstyled row mx-n2">
                            <li class="px-2 col-auto">
                                <img class="img-fluid" src="{{ asset('storage/images/' . ($item['image'] ?? 'default.jpg')) }}" alt="{{ $item['name'] }}" width="60">
                            </li>
                            <li class="px-2 col">
                                <h5 class="text-blue font-size-14 font-weight-bold mb-1">{{ \Illuminate\Support\Str::limit($item['name'], 40) }}</h5>
                                <span class="font-size-14">{{ $item['quantity'] }} × Rs.{{ number_format($item['price'], 2) }}</span>
                            </li>
                            <li class="px-2 col-auto">
                                <form action="{{ route('cart.remove', $id) }}" method="POST">
                                    @csrf
                                    <button type="submit" class="text-gray-90 bg-transparent border-0 p-0">
            ...
            @if(count($cart) > 3)
                <div class="text-center px-4 pb-2">
                    <a href="{{ route('cart.index') }}" class="btn btn-link font-size-14 p-0 text-primary font-weight-bold">See all items ({{ count($cart) }})</a>
                </div>
            @endif

            <div class="flex-center-between px-4 pt-2 pb-3">
                                                        ...
                                                        <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                                             <ul class="navbar-nav u-header__navbar-nav">
                                                                ...
                                                                <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                    ...
                                                                    data-position="left">
                                                                    <a id="basicMegaMenu" class="nav-link u-header__nav-link u-header__nav-link-toggle" href="javascript:;" aria-haspopup="true" aria-expanded="false">{{ $utilitytype->name }}</a>

                                                                    <!-- Nav Item - Mega Menu -->
                                                                    <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu">
                                                                        <div class="vmm-bg">
                                                                            <img class="img-fluid" src="{{ asset('storage/images/'. $utilitytype->path) }}" alt="Image Description">
                                                                        </div>
                                                                        <div class="row u-header__mega-menu-wrapper">
                                                                            <div class="col mb-3 mb-sm-0">
                                                                                <span class="u-header__sub-menu-title">{{ $utilitytype->name }}</span>
                                                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                                                    @foreach($utilitysubtypes->where('category', $utilitytype->id) as $subtype)
                                                                                    <li><a class="nav-link u-header__sub-menu-nav-link" href="#">{{ $subtype->name }}</a></li>                                                                      
                                        ...
                                        <div class="row u-header__mega-menu-wrapper">
                                            <div class="col-md-3">
                                                ...
                                                <ul class="u-header__sub-menu-nav-group">
                                                    ...
                                                    <li><a href="#" class="nav-link u-header__sub-menu-nav-link">About</a></li>
                                                    <li><a href="#" class="nav-link u-header__sub-menu-nav-link">Contact </a></li>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                    <li><a href="#" class="nav-link u-header__sub-menu-nav-link">Shop Category </a></li>
                                                    <li><a  href="#" class="nav-link u-header__sub-menu-nav-link">Shop  </a></li>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <ul class="u-header__sub-menu-nav-group">
                                                    <li><a  href="#"class="nav-link u-header__sub-menu-nav-link">Shop</a></li>
                                                    <li><a  href="#" class="nav-link u-header__sub-menu-nav-link">Cart</a></li>
                                                    <li><a href="#" class="nav-link u-header__sub-menu-nav-link">Checkout</a></li>
                                                 </ul>
                                            </div>
                                            <div class="col-md-3">
                                                <span class="u-header__sub-menu-title">Blog Pages</span>
                                                <ul class="u-header__sub-menu-nav-group mb-3">
                                                    <li><a  href="#" class="nav-link u-header__sub-menu-nav-link">Blog </a></li>
                                                    <li><a  href="#" class="nav-link u-header__sub-menu-nav-link">Single Blog Post</a></li>
                                                </ul>
