    ...
    <div class="bg-primary py-3">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <!-- Subscribe Form -->
                    <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data" class="domain-form-one position-relative">
                                        @csrf
                            <input type="text" class="form-control p-4 rounded-pill" name="email" placeholder="Enter your email Address" required>
                            <div class="domain-submit-box d-flex align-items-center gap-3 position-absolute">
                                <button class="btn px-4 btn-danger rounded-circle" type="submit"><span class="fs-16"><i
                    ...
                    <div class="mb-4">
                        <div class="row no-gutters">
                            ...
                            <div class="col pl-3">
                                ...
                                <a href="tel:+80080018588" class="font-size-20 text-gray-90"> {{ $settings->first()->phone }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="mb-4">
    ...
    <div class="bg-gray-14 py-2">
        <div class="container">
            <div class="flex-center-between d-block d-md-flex">
                <div class="mb-3 mb-md-0">© <a href="#" class="font-weight-bold text-gray-90">{{ $settings->first()->name }}</a> - All rights Reserved</div>
    ...
    <div class="toast align-items-center" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header bg-success text-white d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <img src="assets/images/logo-sm.png" alt="" height="20" class="me-2">
                <strong class="me-auto">Success!</strong>
            </div>
            {{-- <small>Just now</small> --}}
            <button type="button" class="close text-white ml-2" data-dismiss="toast" aria-label="Close">
...
<div class="toast-container position-fixed bottom-0 end-0 p-3 z-2" id="toastPlacement">
    <div class="toast">
        <div class="toast-header bg-warning text-white d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <img src="assets/images/logo-sm.png" alt="" height="20" class="me-2">
                <strong class="me-auto">Whoops! There's a problem!</strong>
            </div>
            {{-- <small>Just now</small> --}}
            <button type="button" class="close text-white ml-2" data-dismiss="toast" aria-label="Close">
            <span aria-hidden="true">&times;</span>
